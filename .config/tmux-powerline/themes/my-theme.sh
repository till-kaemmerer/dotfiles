...
if [ -z "$TMUX_POWERLINE_LEFT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info $thm_rosewater $thm_bg"
		"hostname $thm_lavender $thm_bg"
		# "mode_indicator 165 0"
		#"ifstat 30 255"
		#"ifstat_sys 30 255"
		"lan_ip $thm_mauve $thm_bg"
...
if [ -z "$TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS" ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117"
		"date_day $thm_sapphire $thm_bg"
		"date $thm_sapphire $thm_bg ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
		"time $thm_sapphire $thm_bg ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}"
